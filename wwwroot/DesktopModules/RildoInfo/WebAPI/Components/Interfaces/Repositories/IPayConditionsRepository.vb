Namespace Components.Interfaces.Repositories
    ...
    Public Interface IPayConditionsRepository
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function GetPayConds(portalId As Integer, payCondType As Integer, payCondStart As Single) As IEnumerable(Of Components.Models.PayCondition)
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function GetPayCond(payConditionId As Integer, portalId As Integer) As Components.Models.PayCondition
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function AddPayCond(payCondition As Components.Models.PayCondition) As Components.Models.PayCondition
        ...
        ''' <param name="payCondition">PayCondition Model</param>
        ''' <remarks></remarks>
        Sub UpdatePayCond(payCondition As Components.Models.PayCondition)
        ...
        ''' <param name="payCondition">PayCondition Model</param>
        ''' <remarks></remarks>
        Sub RemovePayCond(payCondition As Components.Models.PayCondition)
