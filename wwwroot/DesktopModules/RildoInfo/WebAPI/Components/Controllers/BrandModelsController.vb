...
Public Class BrandModelsController
    ...
    Private Shared ReadOnly logger As ILog = LoggerSource.Instance.GetLogger(GetType(BrandModelsController))
    ...
    Function GetBrandModels(brandId As Integer, portalId As Integer) As HttpResponseMessage
        Try
            Dim brandModelsData As IEnumerable(Of Components.Models.BrandModel)
    ...
    Function GetBrandModel(modelId As Integer, brandId As Integer) As HttpResponseMessage
        Try
            Dim brandModelData As New Components.Models.BrandModel
    ...
    <DnnAuthorize> _
    <HttpPost> _
    Function UpdateBrandModel(dto As Components.Models.BrandModel) As HttpResponseMessage
        Try
            Dim brandModel As New Components.Models.BrandModel
