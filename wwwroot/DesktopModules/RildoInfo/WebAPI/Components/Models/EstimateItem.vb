...
Namespace Components.Models
    ...
    Public Class EstimateItem
        ...
        <IgnoreColumn> _
        Public Property UnitTypeAbbv As String Implements IEstimateItem.UnitTypeAbbv
        ...
        Public Property NumDav As Integer Implements IEstimateItem.NumDav

        Public Property NumDoc As Integer Implements IEstimateItem.NumDoc

        Public Property NumDavItem As Integer Implements IEstimateItem.NumDavItem
    End Class
End Namespace