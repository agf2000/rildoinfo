...
Namespace Components.Models
    ...
    Public Class Product
        ...
        Public Property ShowPrice As Boolean Implements IProduct.ShowPrice
        ...
        <IgnoreColumn> _
        Public Property UnitTypeAbbv As String Implements IProduct.UnitTypeAbbv
        ...
        <IgnoreColumn> _
        Public Property ProductOptions As IEnumerable(Of ProductOption) Implements IProduct.ProductOptions

        <IgnoreColumn> _
        Public Property ProductOptionValues As IEnumerable(Of ProductOptionValue) Implements IProduct.ProductOptionValues
        ...
        <IgnoreColumn> _
        Public Property Finan_Cost As Single Implements IProduct.Finan_Cost
        ...
        <IgnoreColumn> _
        Public Property Finan_DefaultBarCode As String Implements IProduct.Finan_DefaultBarCode

        <IgnoreColumn> _
        Public Property Finan_TributeSituationType As String Implements IProduct.Finan_TributeSituationType

        <IgnoreColumn>
        Public Property Finan_ICMS As Double Implements IProduct.Finan_ICMS

        <IgnoreColumn> _
        Public Property Finan_PISTributeSituation As String Implements IProduct.Finan_PISTributeSituation

        <IgnoreColumn> _
        Public Property Finan_PISBase As String Implements IProduct.Finan_PISBase

        <IgnoreColumn> _
        Public Property Finan_PIS As String Implements IProduct.Finan_PIS

        <IgnoreColumn> _
        Public Property Finan_PISTributeSubBase As String Implements IProduct.Finan_PISTributeSubBase

        <IgnoreColumn> _
        Public Property Finan_PISTributeSub As String Implements IProduct.Finan_PISTributeSub

        <IgnoreColumn> _
        Public Property Finan_COFINSTributeSituation As String Implements IProduct.Finan_COFINSTributeSituation

        <IgnoreColumn> _
        Public Property Finan_COFINSBase As String Implements IProduct.Finan_COFINSBase

        <IgnoreColumn> _
        Public Property Finan_COFINS As String Implements IProduct.Finan_COFINS

        <IgnoreColumn> _
        Public Property Finan_COFINSTributeSubBase As String Implements IProduct.Finan_COFINSTributeSubBase

        <IgnoreColumn> _
        Public Property Finan_COFINSTributeSub As String Implements IProduct.Finan_COFINSTributeSub

        <IgnoreColumn> _
        Public Property Finan_NCM As String Implements IProduct.Finan_NCM

        <IgnoreColumn> _
        Public Property Finan_CST As String Implements IProduct.Finan_CST

        <IgnoreColumn> _
        Public Property Finan_IPI As Double Implements IProduct.Finan_IPI

        <IgnoreColumn> _
        Public Property Finan_Paid As Single Implements IProduct.Finan_Paid

        <IgnoreColumn> _
        Public Property Finan_DiffICMS As Double Implements IProduct.Finan_DiffICMS

        <IgnoreColumn> _
        Public Property Finan_Freight As Single Implements IProduct.Finan_Freight

        <IgnoreColumn> _
        Public Property Finan_TributeSubICMS As Double Implements IProduct.Finan_TributeSubICMS
        <IgnoreColumn> _
        Public Property VideoSrc As String Implements IProduct.VideoSrc

        Public Property OldId As Integer Implements IProduct.OldId

        <IgnoreColumn> _
        Public Property SyncEnabled As Boolean Implements IProduct.SyncEnabled

        Public Property QtyStockOther As Decimal Implements IProduct.QtyStockOther

        Public Property ScaleProduct As Boolean Implements IProduct.ScaleProduct

        <IgnoreColumn>
        Public Property Trib_Ecf As Integer Implements IProduct.Trib_Ecf

        <IgnoreColumn>
        Public Property SGI_Group As Integer Implements IProduct.SGI_Group
    End Class
End Namespace