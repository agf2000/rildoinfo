...
Public Class pdfPage
    ...
    Public Overloads Overrides Sub OnStartPage(writer As PdfWriter, doc As Document)
        ...
        If HttpContext.Current.Request.Params("customerLogo") IsNot Nothing Then
            ...
            Dim jpgLogo = Nothing
            If HttpContext.Current.Request.Params("customerLogo") <> "" Then
                logoImage = HostingEnvironment.MapPath(CStr(HttpContext.Current.Request.Params("customerLogo")))
                jpgLogo = CType(iTextSharp.text.Image.GetInstance(logoImage), iTextSharp.text.Image)
