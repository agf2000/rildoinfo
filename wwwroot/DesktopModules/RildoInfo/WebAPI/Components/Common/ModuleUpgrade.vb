...
Public Class ModuleUpgrade
            ...
            For Each value As String In countryValues
                For Each country As DotNetNuke.Common.Lists.ListEntryInfo In countries
                    If country.Value = value Then
                        Dim newCountry As New DotNetNuke.Common.Lists.ListEntryInfo() With {
        ...
        If Not regions.Count > 0 Then
            ...
            For Each stateName In statesBR
                ...
                For Each value As String In stateValues
                    Dim myListInfo As New DotNetNuke.Common.Lists.ListEntryInfo() With {
                        .DefinitionID = Null.NullInteger,
    ...
    Private Sub AddInitialPortalData()
        ...
        newSettings.Add("reqAddress", "False")
        newSettings.Add("askAddress", "True")
        newSettings.Add("agendaMessage", "<p>Caro(a) [CLIENTE], saudações.<br /><br />Confirmo através deste e-mail agenda marcada para: [DATA]</p>[SOBRE]")
        newSettings.Add("allowPurchase", "False")
        newSettings.Add("bW_Logo", "/portals/0/logo.png")
        newSettings.Add("ccBlockList", "0.0.0.0")
        newSettings.Add("ccTestMode", "True")
        newSettings.Add("reqCT", "False")
        newSettings.Add("askCT", "False")
        newSettings.Add("reqEIN", "False")
        newSettings.Add("askEIN", "False")
        newSettings.Add("reqCompany", "False")
        newSettings.Add("askCompany", "True")
        newSettings.Add("reqSSN", "False")
        newSettings.Add("askSSN", "False")
        'newSettings.Add("RIW_Custom_Settings", "")
        newSettings.Add("displayName_Required", "False")
        newSettings.Add("displayName_Show", "False")
        newSettings.Add("estimateEmailBody", "<p>Caro(a) [CLIENTE].<br /><br />Acesse seu Orçamento com ([ID]) usando o link apresentado neste email.<br /><br />Clique <a href='[ORCAMENTOLINK]'>aqui</a> para abrir o orçamento.</p>")
        newSettings.Add("estimateEmailSubject", "Seu Orçamento com ([ID]) no website [WEBSITELINK]")
        newSettings.Add("estimateMaxDiscount", "10")
        newSettings.Add("estimateMaxDuration", "3")
        newSettings.Add("estimateTerm", "<p>Validade deste oçamento é de 3 dias. <br> Todas as imagens são meramente ilustrativas. <br> Valores podem ser alterados sem prévio aviso. <br> Prazo de entrega(s) do(s) produtos e execução de serviços a combinar.</p>")
        newSettings.Add("reqIdent", "False")
        newSettings.Add("askIdent", "False")
        newSettings.Add("reqIndustry", "False")
        newSettings.Add("askIndustry", "False")
        newSettings.Add("inventoryCheck", "False")
        newSettings.Add("reqLastName", "False")
        newSettings.Add("askLastName", "True")
        newSettings.Add("mainConsumerId", "1")
        newSettings.Add("mainConsumer", "Consumidor Padrão")
        newSettings.Add("noStockAllowed", "True")
        newSettings.Add("pageSize", "5")
        newSettings.Add("passwordMessage", "<p>Caro(a) [CLIENTE]</p><p>Requisitou os detalhes de sua conta no website <strong>[WEBSITE1]</strong>.</p><table><tbody><tr><td>Endereço do Website</td><td><a href=http://[HTTPURL]>[URL]</a></td></tr><tr><td>Seu Login:</td><td> [LOGIN] </td></tr><tr><td>Sua Senha:</td><td> [SENHA] </td></tr></tbody></table><p><br />Obrigado,<br /><br /><strong>[WEBSITE2]</strong></p>")
        newSettings.Add("passwordSubject", "[WEBSITE] : Detalhes da conta")
        newSettings.Add("productTemplate", "None")
        newSettings.Add("productWatermark", ps.PortalName)
        newSettings.Add("salesPerson", Users.UserController.GetUserByName("vendedor").UserID)
        newSettings.Add("saveCCData", "False")
        newSettings.Add("showEstimatePrice", "True")
        newSettings.Add("showNoStockProduct", "False")
        newSettings.Add("smtpConnection", "True")
        newSettings.Add("smtpLogin", "contato@riw.com.br")
        newSettings.Add("smtpPassword", "Senha123.")
        newSettings.Add("smtpPort", "587")
        newSettings.Add("smtpServer", "smtp.gmail.com")
        newSettings.Add("reqST", "False")
        newSettings.Add("askST", "False")
        newSettings.Add("storeAddress", "Rua Barão de Aiuruoca")
        newSettings.Add("storeCity", "Belo Horizonte")
        newSettings.Add("storeComplement", "Loja A")
        newSettings.Add("storeCountry", "Brasil")
        newSettings.Add("storeDistrict", "João Pinheiro")
        newSettings.Add("storeEmail", "contato@riw.com.br")
        newSettings.Add("storePhone1", "voz=3136538199")
        newSettings.Add("storePhone2", "fax=3136538199")
        newSettings.Add("storePostalCode", "3053009-1")
        newSettings.Add("storeRegion", "Minas Gerais")
        newSettings.Add("storeRepplyEmail", "")
        newSettings.Add("storeUnit", "298")
        newSettings.Add("storeReplyEmail", "contato@riw.com.br")
        newSettings.Add("reqTelephone", "False")
        newSettings.Add("askTelephone", "True")
        newSettings.Add("visitFee", "")
        newSettings.Add("reqWebsite", "False")
        newSettings.Add("askWebsite", "False")
        ...
        For Each SettingName In newSettings
            ...
            For Each value As String In SettingValues
                ...
                '    Portals.PortalController.UpdatePortalSetting(ps.PortalId, SettingName, value)
                '
                Dim presentSetting = settingsCtrl.GetSetting(SettingName, 0)
                presentSetting.SettingName = SettingName
                presentSetting.SettingValue = value
    ...
    Private Sub AddIndustries()
        ...
        Industries.Add("Agência Publicidade")
        ...
        For Each IndustryTitle As String In Industries
            Dim IndustriesInfo As New Components.Models.Industry() With {.PortalId = ps.PortalId, .IndustryTitle = IndustryTitle, .CreatedByUser = 2, .CreatedOnDate = DateTime.Now(), .ModifiedByUser = 2, .ModifiedOnDate = DateTime.Now()}
    ...
    Private Sub AddStatuses()
        ...
        For Each StatusTitle In newStatuses.Keys
            ...
            For Each value As String In StatusColors
                Dim newStatus As New Components.Models.Status() With {
                    .CreatedByUser = 2,
    ...
    Private Sub AddUnitTypes()
        ...
        Dim SettingName As String
        Dim SettingValues() As String
        newSettings.Add("1/4", "One Quarto")
        newSettings.Add("BL", "Barril")
        newSettings.Add("CM", "Centímetro")
        newSettings.Add("CM³", "Centímetro Cúbico")
        newSettings.Add("CX", "Caixa")
        newSettings.Add("DZ", "Dúzia")
        newSettings.Add("G", "Gramas")
        newSettings.Add("GL", "Galão")
        newSettings.Add("JD", "Jradas")
        newSettings.Add("Kg", "Kilo")
        newSettings.Add("L", "Litro")
        newSettings.Add("LB", "Libra")
        newSettings.Add("M", "Metro")
        newSettings.Add("ML", "Milítro")
        newSettings.Add("MM", "Milímetro")
        newSettings.Add("MM3", "Milímetro Cúbico")
        newSettings.Add("M²", "Metro Quadrado")
        newSettings.Add("M³", "Metro Cúbico")
        newSettings.Add("PC", "Pacote")
        newSettings.Add("POL", "Polegadas")
        newSettings.Add("PÉ", "Pés")
        newSettings.Add("T", "Tonelada")
        newSettings.Add("UN", "Unidade")
        ...
        For Each SettingName In newSettings
            SettingValues = newSettings.GetValues(SettingName)
            For Each value As String In SettingValues
                Dim unitTypeInfo As New Components.Models.UnitType() With {
                    .PortalId = ps.PortalId,
                    .UnitTypeAbbv = SettingName,
                    .UnitTypeTitle = value,
                    .CreatedByUser = 2,
                    .CreatedOnDate = DateTime.Now(),
                    .ModifiedByUser = 2,
                    .ModifiedOnDate = DateTime.Now()}
                unitTypeCtrl.AddUnitType(unitTypeInfo)
            Next
        Next
    ...
    Private Sub CreateRoles()
        ...
        Dim objEmployeesRoleInfo = objRoleCtrl.GetRoleByName(ps.PortalId, "Colaboradores")
        If Null.IsNull(objEmployeesRoleInfo) Then
            Dim objNewRole As New RoleInfo() With {.PortalID = ps.PortalId, .RoleGroupID = intRoleGroupID, .RoleName = "Colaboradores", .Description = "Grupo de Colaboradores.", .IsPublic = False, .Status = RoleStatus.Approved}
            objRoleCtrl.AddRole(objNewRole)
        End If
    ...
    Private Sub CreateAccounts()
        ...
        Dim objRoleCtrl As New RoleController
        Dim objRegisteredRoleInfo = objRoleCtrl.GetRoleByName(ps.PortalId, ps.RegisteredRoleName)
        ...
        If objManagerUserInfo Is Nothing Then
            ...
            If objUserCreateStatus = UserCreateStatus.Success Then
                ...
                'Check if this is a User Folder
                Dim UserDir = New System.IO.DirectoryInfo(ps.HomeDirectoryMapPath & userPath.Replace("/", "\"))
                ...
                'End If
                Utilities.CreateDir(PortalController.Instance.GetCurrentPortalSettings(), userPath)

                If Not IO.File.Exists(String.Format("{0}{1}{2}.jpg", ps.HomeDirectoryMapPath, userPath, CStr(objNewManagerUserInfo.UserID))) Then
                    If IO.File.Exists(String.Format("{0}{1}.jpg", ps.HomeDirectoryMapPath, CStr(objNewManagerUserInfo.UserID))) Then
                        IO.File.Copy(String.Format("{0}{1}.jpg", ps.HomeDirectoryMapPath, CStr(objNewManagerUserInfo.UserID)), String.Format("{0}{1}{2}.jpg", ps.HomeDirectoryMapPath, userPath, CStr(objNewManagerUserInfo.UserID)))
                ...
                objRoleCtrl.AddUserRole(ps.PortalId, objNewManagerUserInfo.UserID, objManagerRoleInfo.RoleID, Null.NullDate, Null.NullDate)
                objRoleCtrl.AddUserRole(ps.PortalId, objNewManagerUserInfo.UserID, objRegisteredRoleInfo.RoleID, Null.NullDate, Null.NullDate)

                ' Remove user from subscribers role
                objRoleCtrl.UpdateUserRole(0, objNewManagerUserInfo.UserID, objRegisteredRoleInfo.RoleID, RoleStatus.Approved, True, False)
            End If
        End If
        ...
        If objSalesUserInfo Is Nothing Then
            ...
            If objUserCreateStatus = UserCreateStatus.Success Then
                ...
                'Check if this is a User Folder
                Dim UserDir = New System.IO.DirectoryInfo(String.Concat(ps.HomeDirectoryMapPath, userPath.Replace("/", "\")))
                Dim Path As String = UserDir.ToString
                'If UserDir.Exists = False Then
                '    'Add User folder
                '    DotNetNuke.Services.FileSystem.FolderManager.Instance().AddFolder(ps.PortalId, userPath)
                ...
                If Not IO.File.Exists(String.Format("{0}{1}{2}.jpg", ps.HomeDirectoryMapPath, userPath, CStr(objNewSalesUserInfo.UserID))) Then
                    If IO.File.Exists(String.Format("{0}{1}.jpg", ps.HomeDirectoryMapPath, CStr(objNewSalesUserInfo.UserID))) Then
                        IO.File.Copy(String.Format("{0}{1}.jpg", ps.HomeDirectoryMapPath, CStr(objNewSalesUserInfo.UserID)), String.Format("{0}{1}{2}.jpg", ps.HomeDirectoryMapPath, userPath, CStr(objNewSalesUserInfo.UserID)))
                ...
                Dim objSalesRoleInfo = objRoleCtrl.GetRoleByName(ps.PortalId, "Vendedores")
                objRoleCtrl.AddUserRole(ps.PortalId, objNewSalesUserInfo.UserID, objSalesRoleInfo.RoleID, Null.NullDate, Null.NullDate)
                objRoleCtrl.AddUserRole(ps.PortalId, objNewSalesUserInfo.UserID, objRegisteredRoleInfo.RoleID, Null.NullDate, Null.NullDate)

                ' Remove user from subscribers role
                objRoleCtrl.UpdateUserRole(0, objNewSalesUserInfo.UserID, objRegisteredRoleInfo.RoleID, RoleStatus.Approved, True, False)
            End If
        End If
        ...
        If objCaxiersUserInfo Is Nothing Then
            ...
            If objUserCreateStatus = UserCreateStatus.Success Then
                ...
                If Not IO.File.Exists(String.Format("{0}{1}{2}.jpg", ps.HomeDirectoryMapPath, userPath, CStr(objNewCaxiersUserInfo.UserID))) Then
                    If IO.File.Exists(String.Format("{0}{1}.jpg", ps.HomeDirectoryMapPath, CStr(objNewCaxiersUserInfo.UserID))) Then
                        IO.File.Copy(String.Format("{0}{1}.jpg", ps.HomeDirectoryMapPath, CStr(objNewCaxiersUserInfo.UserID)), String.Format("{0}{1}{2}.jpg", ps.HomeDirectoryMapPath, userPath, CStr(objNewCaxiersUserInfo.UserID)))
                ...
                Dim objCashiersRoleInfo = objRoleCtrl.GetRoleByName(ps.PortalId, "Caixas")
                objRoleCtrl.AddUserRole(ps.PortalId, objNewCaxiersUserInfo.UserID, objCashiersRoleInfo.RoleID, Null.NullDate, Null.NullDate)
                objRoleCtrl.AddUserRole(ps.PortalId, objNewCaxiersUserInfo.UserID, objRegisteredRoleInfo.RoleID, Null.NullDate, Null.NullDate)

                ' Remove user from subscribers role
                objRoleCtrl.UpdateUserRole(0, objNewCaxiersUserInfo.UserID, objRegisteredRoleInfo.RoleID, RoleStatus.Approved, True, False)
            End If
        End If
        ...
        If objClientUserInfo Is Nothing Then
            ...
            If objUserCreateStatus = UserCreateStatus.Success Then
                ...
                If Not IO.File.Exists(String.Format("{0}{1}{2}.jpg", ps.HomeDirectoryMapPath, userPath, CStr(objNewClientUserInfo.UserID))) Then
                    If IO.File.Exists(String.Format("{0}{1}.jpg", ps.HomeDirectoryMapPath, CStr(objNewClientUserInfo.UserID))) Then
                        IO.File.Copy(String.Format("{0}{1}.jpg", ps.HomeDirectoryMapPath, CStr(objNewClientUserInfo.UserID)), String.Format("{0}{1}{2}.jpg", ps.HomeDirectoryMapPath, userPath, CStr(objNewClientUserInfo.UserID)))
                ...
                Dim objClientsRoleInfo = objRoleCtrl.GetRoleByName(ps.PortalId, "Clientes")
                objRoleCtrl.AddUserRole(ps.PortalId, objNewClientUserInfo.UserID, objClientsRoleInfo.RoleID, Null.NullDate, Null.NullDate)
                objRoleCtrl.AddUserRole(ps.PortalId, objNewClientUserInfo.UserID, objRegisteredRoleInfo.RoleID, Null.NullDate, Null.NullDate)

                ' Remove user from subscribers role
                objRoleCtrl.UpdateUserRole(0, objNewClientUserInfo.UserID, objRegisteredRoleInfo.RoleID, RoleStatus.Approved, True, False)
                ...
                'Else
                person.StatusId = 1 ' defaultStatusCtrl.getStatuses(ps.PortalId, "False")(0).StatusId
                'End If
        ...
        If objEditorUserInfo Is Nothing Then
            ...
            If objUserCreateStatus = UserCreateStatus.Success Then
                ...
                If Not IO.File.Exists(String.Format("{0}{1}{2}.jpg", ps.HomeDirectoryMapPath, userPath, CStr(objNewEditorUserInfo.UserID))) Then
                    If IO.File.Exists(String.Format("{0}{1}.jpg", ps.HomeDirectoryMapPath, CStr(objNewEditorUserInfo.UserID))) Then
                        IO.File.Copy(String.Format("{0}{1}.jpg", ps.HomeDirectoryMapPath, CStr(objNewEditorUserInfo.UserID)), String.Format("{0}{1}{2}.jpg", ps.HomeDirectoryMapPath, userPath, CStr(objNewEditorUserInfo.UserID)))
                ...
                objRoleCtrl.AddUserRole(ps.PortalId, objNewEditorUserInfo.UserID, objEditorsRoleInfo.RoleID, Null.NullDate, Null.NullDate)
                objRoleCtrl.AddUserRole(ps.PortalId, objNewEditorUserInfo.UserID, objRegisteredRoleInfo.RoleID, Null.NullDate, Null.NullDate)

                ' Remove user from subscribers role
                objRoleCtrl.UpdateUserRole(0, objNewEditorUserInfo.UserID, objRegisteredRoleInfo.RoleID, RoleStatus.Approved, True, False)
