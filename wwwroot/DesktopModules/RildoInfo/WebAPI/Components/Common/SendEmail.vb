...
Namespace RIW.Modules.Services
...
#Region "Public Properties"
        ...
        Public Property SendingUser() As Users.UserInfo
            ...
            Set(value As Users.UserInfo)
                ...
                Else
                    Dim portalSettings = Portals.PortalController.Instance.GetCurrentPortalSettings()
...
#Region "Private Methods"
        ...
        Private Sub Initialize()
            _portalSettings = Portals.PortalController.Instance.GetCurrentPortalSettings()
...
#Region "Public Methods"
        ...
        Public Function Recipients() As List(Of Users.UserInfo)
            ...
            For Each roleName As String In _addressedRoles
                ...
                For Each objUser As Users.UserInfo In roleController.GetUsersByRole(_portalSettings.PortalId, roleName)
