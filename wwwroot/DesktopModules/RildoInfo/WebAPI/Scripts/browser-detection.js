...
var BrowserDetection = {
    ...
    positionNotice: function () {
        ...
        var offset = (this.browser == "MSIE" && this.browserVersion < 8) ? (window.document.documentElement.scrollTop != 0 ? window.document.documentElement.scrollTop : window.document.body.scrollTop) : 0;
    ...
    defaultNotSupportedBrowsers: [
        { 'os': 'Any', 'browser': 'MSIE', 'version': 5 },
        { 'os': 'Any', 'browser': 'MSIE', 'version': 6 },
        { 'os': 'Any', 'browser': 'MSIE', 'version': 7 },
        { 'os': 'Any', 'browser': 'MSIE', 'version': 8 },
        { 'os': 'Any', 'browser': 'MSIE', 'version': 9 },
        { 'os': 'Any', 'browser': 'Chrome', 'version': 31 },
        { 'os': 'Any', 'browser': 'Firefox', 'version': 25 },
        { 'os': 'Any', 'browser': 'Opera', 'version': 16 },
        { 'os': 'Any', 'browser': 'Safari', 'version': 4 }
    ],
    noticeText: {
        'professional': { "title": "Sabia que seu navegador de internet est&aacute; desatualizado?", "notice": "Seu navegador de internet est&aacute; desatualizado, impedindo a visualiza&ccedil;&atilde;o correta deste website. Nevegadores atualizados permitem o melhor desempenho de websites modernos, como tamb&eacute;m ajudam a proteger o seu computador. Uma lista de navegadores compat&iacute;veis com nosso website pode ser vista abaixo.", "selectBrowser": "Clique no navegador de sua prefer&ecirc;ncia para ser redirecionado para sua p&aacute;gina de instala&ccedil;&atilde;o onde poder&aacute; baixar a vers&atilde;o atualizada.", "remindMeLater": "Me Lembre Novamente", "neverRemindAgain": "N&atilde;o Me Lembre Novamente" },
