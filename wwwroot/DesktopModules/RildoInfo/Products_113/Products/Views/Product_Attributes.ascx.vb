...
Namespace Views
    ...
    Inherits RiwProductsModuleBase
        ...
        Private Sub Page_Init(sender As Object, e As EventArgs) Handles Me.Init
            ClientResourceManagement.ClientResourceManager.RegisterScript(Parent.Page, "DesktopModules/RildoInfo/" & ModuleConfiguration.DesktopModule.FolderName & "/viewmodels/productAttributes.js", 99)
            RegisterModuleInfo()
        End Sub
        ...
        Public Sub RegisterModuleInfo()
            ...
            scriptblock.Append(String.Format("var ascxVersion = ""{0}""; ", System.IO.File.GetLastWriteTime(String.Format("{0}DesktopModules\RildoInfo\{1}\views\product_attributes.ascx", Request.PhysicalApplicationPath, ModuleConfiguration.DesktopModule.FolderName)).ToString("g")))
            scriptblock.Append(String.Format("var jsVersion = ""{0}""; ", System.IO.File.GetLastWriteTime(Request.PhysicalApplicationPath & "DesktopModules\RildoInfo\" & ModuleConfiguration.DesktopModule.FolderName & "\viewmodels\productAttributes.js").ToString("g")))
            scriptblock.Append("</script>")
