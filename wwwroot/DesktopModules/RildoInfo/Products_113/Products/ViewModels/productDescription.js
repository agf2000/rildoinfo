...
$(function () {
    ...
    my.vm = function () {
        ...
        self.productDesc = ko.observable();
    ...
    $.ajax({
        ...
        if (data) {
            my.vm.productDesc(data.Description);
            $('.markdown-editor').val(my.vm.productDesc());
            $('#productDescriptionTextarea').data('kendoEditor').value(my.vm.productDesc());
        } else {
            $.pnotify({
                title: 'Erro!',
                text: data.Result,
    ...
    $('#btnUpdateDescription').click(function (e) {
        ...
        var params = {
            ...
            Lang: 'pt-BR',
            Description: $('#productDescriptionTextarea').data('kendoEditor').value().trim(),
    ...
    $('.btnReturn').click(function (e) {
        ...
        if (my.retSel > 0) {
            switch (my.retSel) {
                case 7:
                    urlAddress = _editURL + '?SkinSrc=[G]Skins/riw/popUpSkin&ContainerSrc=[G]Containers/riw/popUpContainer#personId/' + my.personId + '/sel/7';
                    break;
                case 8:
