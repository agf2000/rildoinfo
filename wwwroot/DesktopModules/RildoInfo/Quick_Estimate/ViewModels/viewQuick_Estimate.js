...
$(function () {
    ...
    my.addEstimateItem = function () {
        ...
        $.ajax({
            ...
            data: JSON.stringify({
                ...
                UserId: -1,
                StatusId: my.statusDropDown.value(), // authorized >= 2 ? 5 : 1,
    ...
    $('#btnPrintReceipt').click(function (e) {
        ...
        var newWindow = window.open('', '_blank');
        var locationStr = 'http://' + siteURL + '/portals/0/downloads/recibo_' + my.estimateId + '.html'; // + '_' + moment().format('DD-MM-YYYY HH').replace(':', '-').replace(' ', '_') + '.html';
        ...
        $.ajax({
            ...
            if (data.Result.indexOf("success") !== -1) {
                setTimeout(function () {
                    ...
                    newWindow.location = 'http://' + siteURL + '/portals/0/downloads/orcamento_' + my.estimateId + '.html'; // + '_' + moment().format('DD-MM-YYYY HH').replace(':', '-').replace(' ', '_') + '.html';
