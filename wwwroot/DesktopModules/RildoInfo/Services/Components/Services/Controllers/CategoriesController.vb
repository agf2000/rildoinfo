...
Public Class CategoriesController
    ...
    Function GetCategoryPermissions(catId As Integer) As HttpResponseMessage
        Try
            Dim catPermissionsData As IEnumerable(Of Models.CategoryPermission)
    ...
    <DnnAuthorize(StaticRoles:="Gerentes,Editores")> _
    <HttpPost> _
    Function UpdateCategory(dto As Models.Category) As HttpResponseMessage
        Try
    ...
    Function GetProductsCategory(Optional categoryId As Integer = 0) As HttpResponseMessage
        Try
            ...
            products = productsCtrl.getProducts(PortalController.GetCurrentPortalSettings().PortalId, categoryId, "pt-BR", "", True, False, "", False, "", 1, 10, "", False, False, "", "", False)
