...
#Region "Subs and Functions"
    ...
    '            _smtpServer = myPortalSettings("RIW_SMTPServer")
    '            _smtpPort = CInt(myPortalSettings("RIW_SMTPPort"))
    '            _authType = "1"
    '            _smtpLogin = myPortalSettings("RIW_SMTPLogin")
    '            _smtpPassword = myPortalSettings("RIW_SMTPPassword")
    '            _smtpSSL = CBool(myPortalSettings("RIW_SMTPConnection"))
    '        End If
...
#Region "Install"
    ...
    Friend Shared Sub AddNotificationTypes()
        ...
        Dim contentType = Constants.ContentTypeName.RIW
