...
Public Class PayConditionsRepository
    ...
    Public Function GetPayConds(portalId As Integer, payCondType As Integer, payCondStart As Decimal) As IEnumerable(Of Models.PayCondition) Implements IPayConditionsRepository.GetPayConds
