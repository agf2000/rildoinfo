...
Public Class PayFormsRepository
    ...
    Public Function GetPayForms(portalId As Integer, isDeleted As String) As IEnumerable(Of Models.PayForm) Implements IPayFormsRepository.GetPayForms
        Return CBO.FillCollection(Of Models.PayForm)(DataProvider.Instance().GetPayForms(portalId, isDeleted))
