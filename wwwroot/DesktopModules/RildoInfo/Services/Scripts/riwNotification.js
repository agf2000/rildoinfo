...
$(function () {
    ...
    //                '/desktopmodules/rildoinfo/services/content/images/ri-logo.png', _siteName, 'Necessitamos de sua atenção no website ' + _siteURL + '.'
    //                );
    ...
    if (Modernizr.audio) {
        if (Modernizr.audio.wav) {
            $("#audiofile").val("/desktopmodules/rildoinfo/services/content/sounds/sample.wav");
        }
        if (Modernizr.audio.mp3) {
            $("#audiofile").val("/desktopmodules/rildoinfo/services/content/sounds/jad0008a.wav");
        }
    }
    else {
        $("#HTML5Audio").hide();
        $("#OldSound").html('<embed src="/desktopmodules/rildoinfo/services/content/sounds/sample.wav" autostart=false width=1 height=1 id="LegacySound" enablejavascript="true" >');
    }    
