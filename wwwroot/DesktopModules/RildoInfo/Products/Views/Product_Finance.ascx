            ...
            <div id="editProductTributes" class="row-fluid">
                <div class="form-horizontal">
                    <div class="span4">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="tribSitType"><strong>Grupo Fiscal SGI:</strong></label>
                            <div class="controls">
                                <input id="sgiGroupTextBox" type="text" class="input-small" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="tribEcfTextBox"><strong>Trib. ECF SGI:</strong></label>
                            <div class="controls">
                                <input id="tribEcfTextBox" type="text" class="input-small" />
                            </div>
                        </div>
                    </div>
                    <div class="span4">
