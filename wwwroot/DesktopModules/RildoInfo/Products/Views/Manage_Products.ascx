...
<div id="divProductsManager" class="row-fluid">
    ...
    <script id="tmplToolbar" type="text/x-kendo-template">
        <ul id="ulToolbar" class="inline">
            ...
            <li>
                <button id="btnExportProduct" class="btn btn-small hidden" data-loading-text="<i class='fa fa-spinner fa-spin'></i>&nbsp; Um momento..."><i class="fa fa-external-link-square"></i>&nbsp; Exportar</button>
            </li>
            <li>
...
<div class="padd7 left">
    <button id="btnSyncProducts" class="btn btn-small" data-loading-text="Um momento...">Importar Produtos</button>
    &nbsp;
    <span id="SyncMsg"></span>
</div>
<div class="padd7 right hidden">
    <button id="btnExportAll" class="btn btn-small" data-loading-text="Um momento...">Exportar Produtos</button>
</div>
<div class="clearfix"></div>
