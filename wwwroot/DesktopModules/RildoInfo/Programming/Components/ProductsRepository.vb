...
#End Region
    ...
    Public Function getProducts(portalId As Integer, categoryId As Integer, lang As String, filter As String, getArchived As Boolean, featuredOnly As Boolean, orderBy As String, orderDesc As String, returnLimit As String, pageIndex As Integer, pageSize As Integer, onSale As String, searchDesc As Boolean, isDealer As Boolean, getDeleted As String, providerList As String, categoryList As String, excludeFeatured As Boolean) As IEnumerable(Of Models.Product) Implements IProductsRepository.getProducts
        Return CBO.FillCollection(Of Models.Product)(DataProvider.Instance().GetProducts_List(portalId, categoryId, lang, filter, getArchived, featuredOnly, orderBy, orderDesc, returnLimit, pageIndex, pageSize, onSale, searchDesc, isDealer, getDeleted, providerList, categoryList, excludeFeatured))
    End Function
    ...
    Public Function getProductHistory(productId As Integer) As IEnumerable(Of Models.InvoiceItem) Implements IProductsRepository.getProductHistory
        Dim products As IEnumerable(Of Models.InvoiceItem)
