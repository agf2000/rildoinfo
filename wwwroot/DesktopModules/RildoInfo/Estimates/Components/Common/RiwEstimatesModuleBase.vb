...
Namespace Components.Common
    ...
    Public Class RiwEstimatesModuleBase
        ...
        Public Sub RegisterModulePath()
            ...
            If UserInfo.Profile.Photo IsNot Nothing Then
                If UserInfo.Profile.Photo.Length > 2 Then
                    ...
                    avatarPath = avatarPath & Services.FileSystem.FileManager.Instance().GetFile(UserInfo.Profile.Photo).FileName
                End If
            End If
            ...
            scriptblock.Append(String.Format("var tModuleID = {0}; ", mCtrl.GetModuleByDefinition(PortalId, "RIW Estimates Manager").TabModuleID))
            'scriptblock.Append(String.Format("var returnURL = ""{0}""; ", NavigateURL()))
            scriptblock.Append(String.Format("var historyURL = ""{0}""; ", NavigateURL(GetPageID("RIW Estimates Manager", PortalId).TabID, "History", "mid=" & CStr(GetModInfo("RIW Estimates Manager", PortalId).ModuleID))))
            ...
            scriptblock.Append(String.Format("var editClientURL = ""{0}""; ", NavigateURL(GetPageID("RIW People Manager", PortalId).TabID, "", "ctl=Edit&mid=" & GetModInfo("RIW People Manager", PortalId).ModuleID)))
            ...
            scriptblock.Append(String.Format("var estimateEmailSubject = ""{0}""; ", mSettings("RIW_EstimateEmailSubject")))
            scriptblock.Append(String.Format("var estimateNotifySubject = ""{0}""; ", mSettings("RIW_EstimateNotifySubject")))
            scriptblock.Append(String.Format("var estimateBody = ""{0}""; ", mSettings("RIW_EstimateEmailBody")))
            scriptblock.Append(String.Format("var estimateNotify = ""{0}""; ", mSettings("RIW_EstimateEmailNotify")))
            ...
            ClientResourceManager.RegisterScript(Parent.Page, "/desktopmodules/rildoinfo/webapi/scripts/riwNotification.js", 51)
