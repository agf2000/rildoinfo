...
Namespace RI.Modules.RIStore_Services
    Public Interface IInvoicesRepository
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function GetInvoices(ByVal portalId As String, ByVal providerId As String, ByVal clientId As String, ByVal prodId As String, ByVal sDate As String, ByVal eDate As String, ByVal pageNumber As Integer, ByVal pageSize As Integer, orderBy As String) As IEnumerable(Of Models.Invoice)
