...
Namespace RI.Modules.RIStore_Services
    Public Class CategoriesController
        ...
        Function GetCategories(portalId As Integer, lang As String, Optional parentId As Integer = -1, Optional filter As String = "", Optional archived As Boolean = False, Optional includeArchived As Boolean = False) As HttpResponseMessage
            Try
                Dim catsData As IEnumerable(Of Models.Category)
                Dim catsDataCtrl As New CategoriesRepository

                catsData = catsDataCtrl.GetCategories_List(portalId, lang, parentId, filter, archived, includeArchived)
        ...
        Function GetCategory(catId As Integer, lang As String) As HttpResponseMessage
            Try
                Dim catData As Models.Category
        ...
        Function GetCategoryLang(catId As Integer, lang As String) As HttpResponseMessage
            Try
                Dim catData As Models.CategoryLang
                Dim catDataCtrl As New CategoriesRepository
        ...
        Function GetCategoryPermissions(catId As Integer) As HttpResponseMessage
            Try
                Dim catPermissionsData As New List(Of Models.CategoryPermission)
        ...
        <HttpPost> _
        Function UpdateCategorySecurity(dto As Models.CategoryPermission) As HttpResponseMessage
            Try
                Dim catPermission As New Models.CategoryPermission
        ...
        <DnnAuthorize(StaticRoles:="Gerentes,Editores")> _
        <HttpPost> _
        Function UpdateCategory(<FromBody> dto As Models.Category) As HttpResponseMessage
            Try
        ...
        Function GetProductsCategory(Optional categoryId As Integer = 0) As HttpResponseMessage
            Try
                ...
                products = productsCtrl.getProducts(PortalController.GetCurrentPortalSettings().PortalId, categoryId, "pt-BR", "", True, False, "", False, 0, 1, 10, False, False, "", False)
