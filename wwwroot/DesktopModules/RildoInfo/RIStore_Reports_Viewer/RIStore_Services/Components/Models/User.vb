...
Namespace RI.Modules.RIStore_Services.Models
    ...
    Public Class User
        ...
        Public ReadOnly Property Email() As String
            Get
                Return If((_viewer.IsInRole(_settings.AdministratorRoleName)), _user.Email, [String].Empty)
            End Get
        End Property
        ...
        Public ReadOnly Property ProfileProperties() As Dictionary(Of String, String)
            Get
                ...
                For Each [property] As ProfilePropertyDefinition In _user.Profile.ProfileProperties
                    Dim value As String = propertyAccess.GetProperty([property].PropertyName, [String].Empty, Thread.CurrentThread.CurrentUICulture, _viewer, Scope.DefaultSettings, propertyNotFound)
        ...
        Public ReadOnly Property UserName() As String
            Get
                Return If((_viewer.IsInRole(_settings.AdministratorRoleName)), _user.Username, [String].Empty)
            End Get
        End Property
