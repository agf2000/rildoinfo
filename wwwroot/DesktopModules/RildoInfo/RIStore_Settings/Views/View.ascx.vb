...
Namespace RI.Modules.RIStore_Settings
    ...
    ''' 
    ''' Because the control inherits from RIStore_SettingsModuleBase you have access to any custom properties
    ''' defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    ''' 
    ''' </summary>
    Partial Class View
        Inherits RIStore_SettingsModuleBase
        Implements IActionable

        Private Sub Page_Init(sender As Object, e As EventArgs) Handles Me.Init
            ClientResourceManagement.ClientResourceManager.RegisterScript(Parent.Page, "/desktopmodules/rildoinfo/ristore_settings/viewmodels/view.js", 99)
        End Sub
