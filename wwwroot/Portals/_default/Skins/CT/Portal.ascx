<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Portal.ascx.cs" Inherits="RIW.Skins.CT.Portal" %>
...
<% if (DotNetNuke.Entities.Users.UserController.GetCurrentUserInfo().IsInRole("Editores")) { %>
	<style type="text/css">
		#dnn_ControlPanel { display: none; }
		#Body { margin-top: 0px !important; }
    </style>
<% } %>
<% if (DotNetNuke.Entities.Users.UserController.GetCurrentUserInfo().IsInRole("Gerentes")) { %>
	<style type="text/css">
		#dnn_ControlPanel { display: none; }
		#Body { margin-top: 0px !important; }
    </style>
...
<div id="MainWrapper">
  <div id="TopArea">
    ...
    <div class="LoginArea searchtext">
      <BR />
...
<% 
    var admin = DotNetNuke.Entities.Users.UserController.GetCurrentUserInfo().IsInRole("Administrators");
    if (admin) {
%>
