...
<dnn:DnnJsInclude ID="customJS" runat="server" FilePath="script/scripts.js" PathNameAlias="SkinPath" />
    ...
    <div id="userControls" class="container">
        <div class="row-fluid">
            ...
            <div id="login" class="span5 pull-right">
                <div class="outerEstimate"><dnn:LOGIN ID="dnnLogin" CssClass="LoginLink" runat="server" LegacyMode="false" /></div>
                <dnn:USER ID="dnnUser" runat="server" LegacyMode="false" /> 
            </div><!--/login-->
        </div>
    </div><!--/userControls-->
    <div id="siteHeadouter" class="outerEstimate">
        ...
        <div class="container">
            ...
            <div class="row-fluid">
                <div class="span3">
                    ...
                    <div class="row-fluid">
				        <div id="leftPaneLowerLeft" class="leftPaneLowerLeft" runat="server" style="margin-right: 20px;"></div>
            ...
            <div id="footer" class="outerEstimate">
                <div class="row-fluid">
